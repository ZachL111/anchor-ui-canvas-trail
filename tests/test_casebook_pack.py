"""Regression checks for the anchor-ui-canvas-trail casebook."""
...
from casebook.harness import assert_expected, anchor_ui_canvas_trail_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(anchor_ui_canvas_trail_summary(), assert_expected())
